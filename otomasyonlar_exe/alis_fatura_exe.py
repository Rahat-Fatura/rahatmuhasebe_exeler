...
def alislar():
    ...
    yeni_alis = driver.find_element(By.XPATH,yenialis_xpath)
    driver.execute_script("arguments[0].click();", yeni_alis)
    # time.sleep(1)
    ...
    for i in range (donme_sayisi):
        ...
        #tedarikci_cari_ara
        cari_arama = driver.find_element(By.XPATH,'//*[@id="select2-supplier-select-container"]')
        driver.execute_script("arguments[0].click();",cari_arama)
        cari_arama.click()
        time.sleep(1)
        ...
        kaydetme = driver.find_element(By.XPATH, kaydet)
        driver.execute_script("arguments[0].click();", kaydetme)
        time.sleep(1)
        ...
        try: 
            ...
            kaydet_onaylama = driver.find_element(By.XPATH, kaydet_onay)
            driver.execute_script("arguments[0].click();",kaydet_onaylama)
